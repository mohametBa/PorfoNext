...
import { FaBootstrap, FaCss3Alt, FaPhp, FaFigma, FaVuejs } from "react-icons/fa";
...
export const TechStackData = [
  {
    ...
    Good: [
      ...
      {
        name: "Vue3",
        icon: <FaVuejs className="md:text-4xl text-2xsl" color="#50cbc0" />
      },
      {
        name: "Android Studio",
        icon: <SiAndroidstudio className="md:text-4xl text-2xl" color={"#31b5ba"} />
      },
      {
        name: "Git",
    ...
    Familiar: [
      {
        name: "Power Bi",
        icon: <SiPowerbi className="md:text-4xl text-2xl" color="#377cc8" />
      },
      {
        name: "Vue3",
        icon: <FaVuejs className="md:text-4xl text-2xsl" color="#50cbc0" />
      ...
      {
        name: "Kotlin",
        icon: <SiKotlin className="md:text-4xl text-2xl" color="#547c99" />
      },
      {
        name: "SASS",
      ...
      {
        name: "Excel",
        icon: <RiFileExcel2Fill className="md:text-4xl text-2xl" color="#08668e" />
      },
      {
        name: "Figma",
        icon: <FaFigma className="md:text-4xl text-2xl" color="#99c14f" />
      }
    ]
